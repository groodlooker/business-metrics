view: order_info {
  ...
  dimension: order_week_of_yearz {
    ...
    link: {
      label: "compare yrz"
      url: "https://localhost:9999/explore/sales/order_info?fields=order_info.order_week_of_yearz,order_info.product_name,order_info.ly_sales,order_info.ty_sales&f[order_info.segment]=Consumer&f[order_info.ytd]=Yes&f[order_info.choose_measure]=sales&f[order_info.order_week_of_yearz]={{value}}&sorts=order_info.ly_sales+desc&limit=500&column_limit=50"
    }
  }
